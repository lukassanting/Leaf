...
export const SLASH_ITEMS: SlashItem[] = [
  ...
  { label: 'New database',  description: 'Create a new database embedded in this page', action: 'database', group: 'Insert', keywords: ['database', 'db', 'table', 'new', 'create'] },
  { label: 'Embed database', description: 'Inline view of an existing database', action: 'database_embed', group: 'Insert', keywords: ['database', 'db', 'table', 'existing', 'inline', 'embed', 'view'] },
